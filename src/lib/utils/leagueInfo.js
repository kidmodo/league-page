/*   STEP 1   */
export const leagueID = "917894223717253120"; // your league ID
export const leagueName = "The CxFFBL"; // your league name
...
export const managers = [
      ...
      "managerID": "465419743952629760",  // the user's manager ID, go to https://api.sleeper.app/v1/league/<your_league_id>/users to find user IDs (you can use older leagueIDs to find user IDs for managers that are no longer in the league)
      "name": "Kevin Rose",
